...
$(window).ready(function () {
  ...
  kmTest.clearCanvas = function () {
    ...
    if (k.converged === false && k.iterations === 0) {
      ctx.font = 'bold 13px sans';
      ctx.fillStyle = 'rgba(0,0,0,1)';
      ctx.fillText('Click to start clustering',10,38);
      return;
    }

    ctx.fillText('Iterations : ' + k.iterations,10,10);
    ctx.fillText('initial centroids: '+(k.kmpp ? 'km++' : 'random'),10,24);
  }
